    ...
    <div className="CreateGroup">
         <div className="create-group-popup">
          ...
          placeholder='Group Name'
               />
               <div className="create-group-body-title">
                   Thêm thành viên
                   </div>
        ...
        <Avatar
          src={testlink}
        />
        <div className="UserListItemName"> Person 1</div>
       </li>
       ...
       <li className="FriendListItem">
        ...
        <div className="UserListItemName"> Person 1</div>
            ...
            <Button color='warning' variant="contained">Create</Button>
                </div>
