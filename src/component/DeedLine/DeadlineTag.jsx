...
function DeadlineTag (props)  {
 ...
 <div className='Deadline-Box'>
        ...
        <div className="row-deadline ">
          <div className="name-col">       <Chip style={{fontweight:600}} label={data.deadline} color="primary" variant='outlined' /></div>
          <div className="description-col"><Chip style={{fontweight:600}} label={data.note} color="primary" variant='outlined'/></div>
